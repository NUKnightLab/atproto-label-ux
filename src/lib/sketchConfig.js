export const sketchConfig = {
  ...
  sections: [
    ...
    { id: 'how-it-works', header: 'How it works' },
    { id: 'multiple-labelers', header: 'Multiple labelers' },
    { id: 'action-url', header: 'Action URL pattern' },
    { id: 'about', header: 'About this demo' }
  ]
};
